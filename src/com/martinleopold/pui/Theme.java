...
public class Theme {
	...
	public Theme(int background,int backgroundText, int outline, int outlineHighlight, int fill, int fillHighlight, int overlay) {
...
//	}
	...
	public final static Theme PERSONALIZADO = new Theme(
        color( 215, 215, 215,  75 ),//background         ok
        color( 245, 245, 245,  100 ),//background         ok
        color( 250, 250, 250,  75 ),//outline            ok
        color( 250, 250, 250, 120 ),//outlineHighlight   ok
        color( 204, 204, 204, 200 ),//fill               ok
        color( 234, 234, 234, 250 ),//fillHighlight      ok
        color( 160, 160, 160, 150 )//overlay             ok
	);
	...
	static enum Preset{
		DEFAULT, HACKER, PERSONALIZADO ,HIPSTER, DIETER, BARBIE, WINDOWS, OSX, 
